...
import { Selector } from '../selector/Selector'; // Asegúrate de importar correctamente el componente Selector
...
export const AddSpeaker: React.FC<AddSpeakerProps> = ({ speakers }) => {
    ...
    const handleSelectedOrganizer = (selected: Organizer[]) => {
        setSelectedOrganizer(selected.length > 0 ? selected[0] : null);
    };
                    ...
                    >
                        <div className="modal-content py-4 text-left px-6">
                            ...
                            <div className="flex justify-between items-center pb-3">
                                <p className="text-xl font-bold">Añadir conferencista</p>
                                <div
                            ...
                            <form>
                                ...
                                <div className="my-5 flex flex-col gap-4">
                                    <div className="flex flex-col gap-1">
                                        <span>¿El conferencista es un empleado?</span>
